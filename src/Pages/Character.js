...
const Character = () => {
    const [characterList, setCharaterList] = useState([
        {characterName: 'Orochimaru', description: "Lorem ipsum dolor sit amet, consectetur adipiscing elit", image: orochimaru},
        {characterName: 'Hisoka', description: "Lorem ipsum dolor sit amet, consectetur adipiscing elit", image: hisoka}
      ...
      {characterList.map((character) => (
        ...
        {/* {blogs.map((blog) =>  (
            <div className="blog-preview" key={blog.id}>
                ...
                <button onClick={()=> console.log(blog.id)}>Post ID</button>
            </div>
        ))} */}
